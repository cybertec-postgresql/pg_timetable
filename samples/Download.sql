...
BEGIN
	...
	INSERT INTO timetable.parameter (chain_id, task_id, order_id, value)
	    VALUES (v_chain_config_id, v_task_id, 1, '["-x", "Latin-ASCII", "-o", "orte_ansi.txt", "orte.txt"]'::jsonb);
	...
	INSERT INTO timetable.parameter (chain_id, task_id, order_id, value)
	    VALUES (v_chain_config_id, v_task_id, 1, '{"sql": "COPY location FROM STDIN", "filename": "orte_ansi.txt" }'::jsonb);
