...
| `run_uid`             | `text`    | The user as which the chain should be executed with.                              |
...
If you want to contribute to **pg_timetable** and help make it better, feel free to open an [issue][issue] or even submit a pull request.
